...
namespace Test
{
    public partial class Load : Form
    {
        private Sema sema;
        private Form1 forma;
        private List<string> pokaznaLista = new List<string>();
        private List<int> id_lista = new List<int>();
        public Load(Sema m,Form1 form)
        {
            InitializeComponent();
            prikaziSve();
            sema = m;
        ...
        {
             pokaznaLista = new List<string>();
             id_lista = new List<int>();
            listBox1.Items.Clear();
                ...
                try
                {
                    ...
                    con.Open();
                    int broj = tezina;
                    int broj1 = Convert.ToInt32(godina);
                    
                    StringBuilder strSQL = new StringBuilder();

                    strSQL.Append("SELECT ID,DAN,MESEC,GODINA,IME,OCENA ");
                    strSQL.Append(" FROM SEMA ");
                    strSQL.Append(" where OCENA=:broj and GODINA=:broj1 ");
                    ...
                    paramBroj = new OracleParameter("broj1", OracleDbType.Int32);
                    paramBroj.Value = broj1;
                ...
                foreach (string k in pokaznaLista)
                {
                    listBox1.Items.Add(k);
                }
                //MessageBox.Show("Filtrira i godine i tezine");
                    //listBox1.Items.Add(pokaznaLista[0]);
                }
                else if (godina=="nebitno" && tezina!=-1) 
                {
                 //   MessageBox.Show("Filtrira tezine");
                OracleConnection con = null;
                string conString = "Data Source = gislab-oracle.elfak.ni.ac.rs:1521/SBP_PDB; User Id = S16171; Password = S16171;";
                ...
                try
                {
                    ...
                    strSQL.Append("SELECT ID,DAN,MESEC,GODINA,IME,OCENA ");
                    strSQL.Append(" FROM SEMA ");
                    strSQL.Append(" where OCENA=:broj ");
                ...
                {
                    //MessageBox.Show("Filtrira i godine");
                ...
                try
                {
                    ...
                    con = new OracleConnection(conString);
                    con.Open();
                    int broj = Convert.ToInt32(godina);
                    
                    StringBuilder strSQL = new StringBuilder();
                    
                    strSQL.Append("SELECT ID,DAN,MESEC,GODINA,IME,OCENA ");
                    strSQL.Append(" FROM SEMA ");
                    strSQL.Append(" where GODINA=:broj ");
                ...
                {
                   // MessageBox.Show("Nema filtera, prikazi sve");
                    prikaziSve();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (listBox1.SelectedIndex != -1)
            {
                ...
                OracleConnection con = null;
                string conString = "Data Source = gislab-oracle.elfak.ni.ac.rs:1521/SBP_PDB; User Id = S16171; Password = S16171;";
                int broj = id_lista[listBox1.SelectedIndex];
